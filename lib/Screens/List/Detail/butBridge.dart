...
// ABS
class ButBridge extends StatelessWidget {
...
// ===========================================
      ...
      child: Column(
        ...
        children: [
          NeonCircularTimer(
            ...
            innerFillColor: Color.fromARGB(31, 255, 0, 0),
    ...
    return Scaffold(
        ...
        body: ListView(
          ...
          children: [
            Image.asset('assets/gifs/ezgif.com-gif-maker(14).gif',
